...
import org.uusoftware.barometer.adapter.Child;
import org.uusoftware.barometer.adapter.ExpandListAdapter;
import org.uusoftware.barometer.adapter.Group;
		...
		ExpandList.setOnChildClickListener(new OnChildClickListener() {
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (groupPosition == 3) {
					...
					i.putExtra(Intent.EXTRA_SUBJECT, "Barometer");
					try {
